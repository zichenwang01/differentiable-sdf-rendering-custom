...
CONFIG_DICTS = [
    ...
    {   # exp_suzanne_batch_new
        'name': 'exp_suzanne_batch_new',
        'config_class': SdfConfig,
        'sensors': (get_sensors, 12),
        'sdf_regularizer_weight': 1e-5,
        'sdf_regularizer': reg.eval_discrete_laplacian_reg,
...
{   # exp_diffuse (h2 and big)
    ...
    {   # exp_buddha_adaptive_lr
        'name': 'exp_buddha_adaptive_lr',
        'config_class': SdfConfig,
        'sensors': (get_sensors, 24),
        'sdf_regularizer_weight': 1e-5,
        'sdf_regularizer': reg.eval_discrete_laplacian_reg,
    ...
    {   # exp_bunny_bottom
        'name': 'exp_bunny_bottom',
        'config_class': SdfConfig,
        'sensors': (get_bottom_sensor, 1),
        # 'sensors': (get_regular_cameras, 6),
        'sdf_regularizer_weight': 1e-5,
        'sdf_regularizer': reg.eval_discrete_laplacian_reg,
        'loss': losses.l1,
    ...
    {   # exp_logo_bottom
        'name': 'exp_logo_bottom',
        'config_class': SdfConfig,
        'sensors': (get_bottom_sensors, 4),
        'sdf_regularizer_weight': 1e-5,
        'sdf_regularizer': reg.eval_discrete_laplacian_reg,
        'loss': losses.l1,
        'upsample_iter': [100, 150],
    ...
    {   # exp_suzanne_bottom
        'name': 'exp_suzanne_bottom',
        'config_class': SdfConfig,
        'sensors': (get_suzanne_sensors, 6),
        'sdf_regularizer_weight': 1e-5,
        'sdf_regularizer': reg.eval_discrete_laplacian_reg,
        'loss': losses.l1,
        'upsample_iter': [100],
    ...
    {
        'name': 'vbunny-no-tex-32-hq',
        'parent': 'no-tex-12-hq',
        'sensors': (get_sensors, 32),
    }, 
